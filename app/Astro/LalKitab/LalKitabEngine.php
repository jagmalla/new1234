...
final class LalKitabEngine
{
    ...
    private static function houseReadings(array $house, array $occupants, array $planets = []): array
    {
        ...
        for ($h = 1; $h <= 12; $h++) {
            ...
            // चेतावनी वाले भाव पर "उन्नति व अनुकूल फल" अकेला नहीं छोड़ा जाता। दर्जा
            // और चेतावनी दो अलग बातें हैं, और पढ़ने वाला अच्छी पंक्ति पढ़कर ऊपर की
            // चेतावनी छोड़ देता है — इसलिए दोनों एक ही साँस में कही जाती हैं।
            if ($warn !== [] && ($verdict === 'शुभ' || $verdict === 'मिश्रित')) {
                $hPredHead .= ' पर इस भाव पर चेतावनी भी है (नीचे देखें) — वह दर्जे के अच्छे होने से नहीं टलती।';
            }
            $hPredEffects = [];
            foreach ($occ as $oe) {
