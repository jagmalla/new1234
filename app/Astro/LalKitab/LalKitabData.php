...
final class LalKitabData
{
    ...
    public const HELPS_BY_HOUSE = [
        ...
        // बुध किस घर में किस ग्रह को मदद दे — भाव 1-2 व 9-12 शनि की, 3-8 सूरज की।
        'Mercury' => [
            1 => ['Saturn'], 2 => ['Saturn'],
            3 => ['Sun'], 4 => ['Sun'], 5 => ['Sun'], 6 => ['Sun'], 7 => ['Sun'], 8 => ['Sun'],
            9 => ['Saturn'], 10 => ['Saturn'], 11 => ['Saturn'], 12 => ['Saturn'],
        ],
    ];
    ...
    public const PLANET_NIYAM = [
        ...
        'Moon' => [
            'चंद्र का घर भाव-5 खाली हो तो चंद्र सारी उम्र नेक फल दे; और चंद्र के इस घर (5) में अकेला बैठा कोई भी ग्रह उत्तम फल देता है।',
            'पापी टोला (राहु-केतु-शनि) सदा चंद्र के दूध में ज़हर घोले; ऐसे समय उपाय खुद चंद्र का ही करें। चंद्र जब किसी शत्रु/पापी को देखे तो अपना नेक असर देना बंद कर दे।',
            'चंद्र के सामने (बामुक़ाबिल) पापी बैठे हों तो मंदे चंद्र का बुरा असर टेवे वाले पर नहीं, उसके क़रीबी रिश्तेदारों पर पड़े।',
            'फटा दूध (मंदा चंद्र) दही (शुक्र) का काम न दे — मंदे चंद्र वाले को शुक्र की वस्तुओं से लाभ नहीं; पर चंद्र की अपनी वस्तु (बहता पानी) से नफ़ा रहे। पानी की बर्फ़ मुबारक, आसमानी/मलाई की बर्फ़ नहीं; सफ़ेद (दूध-रंग) वस्तु नेक चंद्र का सबूत।',
            'चंद्र↔बुध: चंद्र बुध से पहले घरों में → चंद्र प्रबल (गैबी अच्छा, दुनियावी दोनों मंदे); बुध पहले → बुध प्रबल। भाव 4-7 में मुश्तरका हों तो कभी नेक फल न दें। चंद्र↔शनि: चंद्र देखे शनि को → शनि मंदा पर चंद्र उम्दा; शनि देखे चंद्र को → चंद्र बर्बाद, शनि बहाल।',
            'किसी के पाँव छूकर आशीर्वाद लेना चंद्र-माता का उत्तम फल पाने की सबसे बढ़िया बुनियाद। पहले घरों में गुरु व बाद में केतु हो तो चंद्र मंदा — पर बुध उम्दा रहे तो चंद्र दूध-सा उत्तम।',
            'चंद्र के साथ बृहस्पति (सोना) हो तो दोनों कभी मंदे नहीं होते और न दुश्मन ग्रहों से मार खाते हैं।',
        ],
        'Venus' => [
            'शुक्र के शत्रु — सूरज, चंद्र, राहु। अकेला बैठा शुक्र कभी बुरा असर नहीं देता। राहु-केतु मुश्तरका = मसनूई शुक्र।',
            'मर्द के टेवे में शुक्र = स्त्री; औरत के टेवे में शुक्र = उसका पति। भाव 1-6 = जवानी/उठती अवस्था, भाव 7-12 = बुढ़ापा।',
            'जिस भाव को शुक्र देखे, वहाँ का ग्रह मंदे वक्त/वर्षफल में शुक्र को मंदा कर देता है — सिवाय सूरज के।',
            'शुक्र, शनि की आँख का मालिक — जिस भाव में शनि हो, शुक्र में वैसा ही असर व उसी भाव की दृष्टि होती है (पर दृष्टि की चाल शुक्र की अपनी, पिछली तरफ)।',
            'शुक्र↔बुध: बुध पहले घरों में हो → मिलाप में केतु की नेक नीयत; शुक्र पहले हो → राहु की बुरी नीयत। शुक्र-12 व बुध-6 → दोनों उच्च (केतु का उत्तम फल)।',
            'सूरज-शनि साथ → बुरा असर नहीं; पर शनि+शुक्र हों व कोई तीसरा उन्हें देखे तो वह देखने वाला ग्रह नष्ट हो जाए। सूरज शनि को देखे → शुक्र बर्बाद; शनि सूरज को देखे → शुक्र आबाद। राहु दृष्टि से मिले → शुक्र बर्बाद (लक्ष्मी व स्त्री दोनों तबाह)।',
        ],
        'Mars' => [
            'सूरज+बुध इकट्ठे → मंगल नेक; सूरज+शनि इकट्ठे → मंगल बद।',
            'मंगल के दो रूप — मंगल नेक (शेर-बहादुर, हमलावर, दानी) व मंगल बद (डरपोक हिरन; बदी का बदला खूनी)। अकेला मंगल जंगल के शेर-सा बहादुर, कभी बुरा नहीं।',
            'भाव-5 (नाभि/खून का घर) में जो ग्रह बैठा हो, वैसी ही मंगल के खून व नेक/बद की हालत होती है।',
            'कोई दो पापी (शनि-राहु या शनि-केतु), या दो बाहम-दुश्मन (बुध-केतु, सूरज-शुक्र) मंगल के साथ हों तो मंगल बद नहीं होता। बुध मंदा हो तो मंगल-बद और भी मंदा।',
            'मंगल↔शनि: मंगल देखे शनि को → मंगल सिफर पर शनि दुगुना उम्दा; शनि देखे मंगल को → दोनों उम्दा। मंगल भाव-3 में शनि निर्धन; अकेला मंगल भाव-10 (शनि का घर) में राजा।',
            'मंगल↔राहु: मंगल देखे राहु → राहु का बुरा असर नहीं; राहु देखे मंगल → बाजू/पेट/खून व दायें हिस्से में तकलीफ (चंद्र-उपाय)। मंगल↔केतु आमने-सामने → दोनों मंदे (शेर-कुत्ते की लड़ाई)।',
            'मंगल-बद किस पर मंदा: भाव 1-4 → अपनी जान व खून पर (केतु मंदा हो तो सिर्फ़ धन-दौलत); भाव 5·9·12 → अपनी जान व खून पर; भाव 6·10·11 → दूसरों पर, केवल धन-दौलत हेतु (बुध मंदा हो तब)। मंगल-बद/मंगलीक (सिवाय भाव 8·12) 28 वर्ष तक अपने से बड़े भाई ले मरे — मंगल-4 छोटे भाई पर, मंगल-12 बड़े भाइयों पर; 70 वर्ष तक खानदान पर मंदा।',
        ],
        'Mercury' => [
            'बुध = आसमान का खाली दायरा/खलाव — "किसी चीज़ के न होने" की हालत ही बुध का होना है। अकेला बैठा बुध निकम्मा — जिस ग्रह का वह पक्का घर है उसी का फल दे (उलटे पाँव लटका चमगादड़, अँधेरे में खुफ़िया शरारत करता)।',
            'बुध बुरे ग्रह के साथ सबसे मंदा, भले ग्रह के साथ भला — और खुद भी भला हो जाए; जिससे मिले उसी की ताकत का असर दे।',
            'बुध अमूमन भाव 3·8·9·12 में मंदा। सिर्फ़ भाव-5 का बुध राजयोग है (वहाँ राहु-केतु पाप न करने की कसम खाते); बाकी हर जगह पाप बुध के दायरे में चलते हैं।',
            'बुध का दुश्मन चंद्र — चंद्र-राहु के झगड़े में बुध बर्बाद/मारा जाए। शुक्र+बुध इकट्ठे मुबारक (भाव-7 दोनों का पक्का घर); अपने से सातवें अलग हों तो दोनों का फल रद्दी।',
            'जहर-आलूदा बुध भाव 1-5 में साथ बैठे ग्रह पर मंदा न दे (सिवाय भाव-3, जहाँ दूसरों के लिए कोढ़ी); भाव 11-12 में जिसे काटे वह हड़काए कुत्ते-सा आगे काटता जाए।',
            'बुध किस घर में किस ग्रह का फल दे: भाव-1 सूरज · 2 गुरु · 3 मंगल · 4 चंद्र · 5 गुरु · 6 केतु · 7 शुक्र · 8 मंगल-शनि · 9 गुरु · 10 शनि · 11 गुरु · 12 राहु का। (मंदा हो तो प्रायः उस वक्त भाव-9 में बैठे ग्रह को बर्बाद करे।)',
            'मंदे बुध के उपाय: नाक छेदन (4-5 दिन/96 घंटे सुराख़ कायम), फिटकरी से दाँत साफ़, लड़कियों/बकरी की सेवा या बकरी-दान, हलवा-कद्दू धर्मस्थान में देना। थुथलापन (लुक्नत) हो तो बुध और कोई मंदा फल न दे।',
        ],
        'Saturn' => [
            'शनि = दुनिया का मुनसिफ़ (जज) — बुध (कागज़) के दायरे में राहु (अभियोगी) व केतु (बचाव) की लिखत पर धर्म से फैसला करे। बृहस्पति ने शनि के घर भाव-11 (कुम्भ) में धर्म-अदालत मुक़र्रर की।',
            'शनि का सिर राहु व दुम केतु; एजेंट — नेक हालत में केतु, मंदी हालत में राहु। केतु पहले घरों व शनि बाद में हो → इच्छाधारी (हर तरह मदद करने वाला); उलटा (राहु पहले, केतु बाद) या दुश्मन के साथ → अजदहा-खूनी/मंदा।',
            'नेक हालत में बृहस्पति के घरों (भाव 2·5·9·12) में शनि कभी बुरा न दे; बृहस्पति कायम व चंद्र दुरुस्त हो → शनि ठंडा-सरसब्ज़ पहाड़ (वैद-धन्वंतरि)। स्याह अशिया पर शनि हमेशा बुरा।',
            'शनि↔सूरज: सूरज शनि को देखे → शुक्र का बुरा; शनि सूरज से पहले बैठे → नर-ग्रह/स्त्री उम्दा। शनि↔शुक्र: शनि की नज़र शुक्र में जाए → दीगर की माया खा जाए; शनि शुक्र को देखे → सब ग्रह मदद करें। स्त्री-ग्रहों के साथ शनि भाव 1·7·4·10 में राहु-केतु का बुरा असर दे; दुश्मन (सूरज-चंद्र-मंगल) के साथ हो तो उन्हें नष्ट करे।',
            'दंश: अकेला साँप (शनि) मासूम बच्चों को ज़हर न दे; पर दो मसनुई साँप (बृहस्पति-शुक्र = केतु-स्वभाव, मंगल-बुध = राहु-स्वभाव) इकट्ठे हों तो डंक मारें। चंद्र-राहु मुश्तरका या भाव-12 में → शनि जहरीला।',
            'नेक असर के वर्ष 10·19·37; मंदी हालत के भारी वर्ष 9·18·27·36। दशा = सन्यास/मकान-जायदाद, चालाकी से धन (36 वर्ष)। शनि तमाम ब्रह्मांड के मकानों व हर एक की नेकी-बदी के आमालनामों का लेखा-जोखा।',
            'उपाय: शनि की अशिया (बादाम, लोहा, चिमटा, तवा) गरीबों/साधुओं को दान; ज़मीन में सुरमा दबाना; बड़ की जड़ के दूध का तिलक। स्याह-राख का तिलक पिता पर भारी। क्याफा: उंगलियों की पोरों पर जौ के निशान गिनकर 12 घटाएँ — शेष ही शनि का भाव।',
        ],
    ];
